...
const SuggSlider = (props) => {
    ...
    <div className="story-product-tile-story-carousel-container">
      <div className="imagecontainer">
        <a className="link story-product-tile__link">
          <img className="sliderPhoto" src={product.productimgurl} />
  ...
  const randomimageContainer = (
    <div className="story-product-tile-story-carousel-container">
      <div className="imagecontainer">
        <a className="link story-product-tile__link">
          <img className="sliderPhoto" src={randomProd1.productimgurl} />
          <h2 className="product-name">{randomProd1.productname}</h2>
          <span className="price">
            $
            {randomProd1.productprice}
            .00
            <abbr className="currency"> USD</abbr>
          </span>
        </a>
  ...
  const randomimageContainer1 = (
    <div className="story-product-tile-story-carousel-container">
      <div className="imagecontainer">
        <a className="link story-product-tile__link">
          <img className="sliderPhoto" src={randomProd2.productimgurl} />
          <h2 className="product-name">{randomProd2.productname}</h2>
          <span className="price">
            $
            {randomProd2.productprice}
            .00
            <abbr className="currency"> USD</abbr>
          </span>
        </a>
  ...
  const randomimageContainer2 = (
    <div className="story-product-tile-story-carousel-container">
      <div className="imagecontainer">
        <a className="link story-product-tile__link">
          <img className="sliderPhoto" src={randomProd3.productimgurl} />
          <h2 className="product-name">{randomProd3.productname}</h2>
          <span className="price">
            $
            {randomProd3.productprice}
            .00
            <abbr className="currency"> USD</abbr>
          </span>
        </a>
  ...
  const randomimageContainer3 = (
    <div className="story-product-tile-story-carousel-container">
      <div className="imagecontainer">
        <a className="link story-product-tile__link">
          <img className="sliderPhoto" src={randomProd4.productimgurl} />
          <h2 className="product-name">{randomProd4.productname}</h2>
          <span className="price">
            $
            {randomProd4.productprice}
            .00
            <abbr className="currency"> USD</abbr>
          </span>
        </a>
  ...
  return (
    <div className="test">
      ...
      <CarouselProvider
        ...
        hasMasterSpinner
      >
        <Slider className="carousel-main" classNameTrayWrap="slidertray">
          <Slide index={0}>
        ...
        <div className="carousel-bottom-slider-container">
          <DotGroup className="carousel-bottom-slider" />
        </div>
      </CarouselProvider>
